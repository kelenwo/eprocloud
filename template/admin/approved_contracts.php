...
<div class="panel-heading">
  <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar">
    <span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a>Approved Bids</h3>
</div>
...
<div class="">
 ...
 <li class="active"><a class="" href="#tab1" data-toggle="tab">Approved Bids</a></li>
   </ul>
...
<?php if($req['contract_status']!=="active"): ?>
        <div class="col-sm-12 col-md-12 mt-3">
          ...
          <form id="update_contract_<?php echo $req['id'];?>">
            ...
            <input type="hidden" name="bid_number" value="<?php echo $req['bid_number'];?>">
...
<!-- General Information end -->
      ...
      <div class="modal-footer mt-2">
        ...
        <div class="form-group text-center mt-5">
          <?php if($req['has_finished']=="yes"): ?>
            <form id="update_contract_<?php echo $req['id'];?>">
              <input type="hidden" name="id" value="<?php echo $req['id'];?>">
              <input type="hidden" name="bid_by_email" value="<?php echo $req['bid_by_email'];?>">
              <input type="hidden" name="bid_number" value="<?php echo $req['bid_number'];?>">
              <input type="hidden" name="has_finished" value="completed"></div>
        </form>
    <button class="btn pl-5 pr-5 btn-success" id="save-<?php echo $req['id'];?>"><i class="far fa-edit"></i> Mark Contract Completed &nbsp;
...
$("#loading-<?php echo $req['id'];?>").hide();
  if(data=="true") {
$("#msg-<?php echo $req['id'];?>").html('Contract has been Completed');
