...
<input type="hidden" name="id" value="{id}">
                  ...
                  <div class="col-sm-5 col-md-5 ml-4 mt-3">
                    ...
                    <br>
                    <select name="marital_status" class="form-control" placeholder="msas">
              ...
              <select name="religion" class="form-control">
                ...
                <option value="Islam" <?php if($religion=='others'){ echo 'selected';} ?>>Islam</option>
                <option value="others" <?php if($religion=='others'){ echo 'selected';} ?>>Others</option>
              </select>
            </div>
  ...
  <input class="form-control form-control-user" type="text" value="{company_country}" name="company_country" placeholder="Country">
    ...
    <div class="row">
                    ...
                    <?php else:?>
                  <h6>{doc1_title} <small><a href="<?php echo base_url();?>uploads/documents/{doc1}">View/Download</a></small></h6>
                <?php endif;?>
                  <b id="loading1"><i class="fas fa-spinner fa-spin"></i> Uploading file, please wait.</b>
                  <b id="success1"></b>
                    <div class="input-group">
            <input type="text" name="doc1_title" value="{doc1_title}" class="form-control form-control-user small" placeholder="Title of document">
                  <div class="input-group-append">
                    ...
                    <div class="">
                      ...
                      <?php if(empty($doc2)):?>
                        <h6>No document uploaded.</h6>
                      <?php else:?>
                    <h6>{doc2_title} <small><a href="<?php echo base_url();?>uploads/documents/{doc2}">View/Download</a></small></h6>
                  <?php endif;?>
                      <b id="loading2"><i class="fas fa-spinner fa-spin"></i> Uploading file, please wait.</b>
                      <b id="success2"></b>
                      <div class="input-group">
              <input type="text" name="doc2_title" value="{doc2_title}" class="form-control form-control-user small" placeholder="Title of document">
                    <div class="input-group-append">
                        ...
                        </div><input type="hidden" value="{doc2}" name="doc2" class="docs2">
                            </div></div>
          </div></div>
            ...
            <div class="col-sm-5 col-md-5 ml-4 mt-3">
              ...
              <?php if(empty($doc3)):?>
                <h6>No document uploaded.</h6>
              <?php else:?>
            <h6>{doc3_title} <small><a href="<?php echo base_url();?>uploads/documents/{doc3}">View/Download</a></small></h6>
          <?php endif;?>
              <b id="loading3"><i class="fas fa-spinner fa-spin"></i> Uploading file, please wait.</b>
              <b id="success3"></b>
              <div class="input-group">
      <input type="text" name="doc3_title" value="{doc3_title}" class="form-control form-control-user small" placeholder="Title of document">
            <div class="input-group-append">
                ...
                </div> <input type="hidden" value="{doc3}" name="doc3" class="docs3">
                    </div></div><br>
            ...
            <div class="">
              ...
              <?php if(empty($doc1)):?>
                <h6>No document uploaded.</h6>
              <?php else:?>
            <h6>{doc4_title} <small><a href="<?php echo base_url();?>uploads/documents/{doc4}">View/Download</a></small></h6>
          <?php endif;?>
              <b id="loading4"><i class="fas fa-spinner fa-spin"></i> Uploading file, please wait.</b>
              <b id="success4"></b>
              <div class="input-group">
      <input type="text" name="doc4_title" value="{doc4_title}" class="form-control form-control-user small" placeholder="Title of document">
            <div class="input-group-append">
                ...
                </div><input type="hidden" value="{doc4}" name="doc4" class="docs4">
                          </div></div>
